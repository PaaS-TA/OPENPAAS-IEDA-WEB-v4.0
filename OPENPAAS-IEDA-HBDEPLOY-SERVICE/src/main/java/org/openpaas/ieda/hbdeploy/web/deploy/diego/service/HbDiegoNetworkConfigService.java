                    ...
                    if (sameNetworkConfigNameList != null && sameNetworkConfigNameList.size() != 0) {
                        for (int j = 0; j < sameNetworkConfigNameList.size(); j++) {
                            if (sameNetworkConfigNameList.size() == 1) {
                                ...
                                vo.setSubnetReservedFrom(sameNetworkConfigNameList.get(0).getSubnetReservedFrom() + "-"
                                        + sameNetworkConfigNameList.get(0).getSubnetReservedTo());
                                vo.setSubnetStaticFrom(sameNetworkConfigNameList.get(0).getSubnetStaticFrom() + "-"
                                        + sameNetworkConfigNameList.get(0).getSubnetStaticTo());
                                resultList.add(vo);
                                break;
                                ...
                                vo.setSubnetId(sameNetworkConfigNameList.get(0).getSubnetId() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetId());
                                vo.setSubnetDns(sameNetworkConfigNameList.get(0).getSubnetDns() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetDns());
                                vo.setSubnetRange(sameNetworkConfigNameList.get(0).getSubnetRange() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetRange());
                                vo.setSubnetGateway(sameNetworkConfigNameList.get(0).getSubnetGateway() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetGateway());
                                vo.setSubnetReservedFrom(sameNetworkConfigNameList.get(0).getSubnetReservedFrom() + "-"
                                        + sameNetworkConfigNameList.get(0).getSubnetReservedTo() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetReservedFrom() + "-"
                                        + sameNetworkConfigNameList.get(1).getSubnetReservedTo());
                                vo.setSubnetStaticFrom(sameNetworkConfigNameList.get(0).getSubnetStaticFrom() + "-"
                                        + sameNetworkConfigNameList.get(0).getSubnetStaticTo() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetStaticFrom() + "-"
                                        + sameNetworkConfigNameList.get(1).getSubnetStaticTo());
                                resultList.add(vo);
                                break;
                                ...
                                vo.setIaasType(sameNetworkConfigNameList.get(0).getIaasType());
                                vo.setCloudSecurityGroups(sameNetworkConfigNameList.get(0).getCloudSecurityGroups()
                                        + "<br>" + sameNetworkConfigNameList.get(1).getCloudSecurityGroups() + "<br>"
                                        + sameNetworkConfigNameList.get(2).getCloudSecurityGroups());
                                vo.setSubnetId(sameNetworkConfigNameList.get(0).getSubnetId() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetId() + "<br>"
                                        + sameNetworkConfigNameList.get(2).getSubnetId());
                                vo.setSubnetDns(sameNetworkConfigNameList.get(0).getSubnetDns() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetDns() + "<br>"
                                        + sameNetworkConfigNameList.get(2).getSubnetDns());
                                vo.setSubnetRange(sameNetworkConfigNameList.get(0).getSubnetRange() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetRange() + "<br>"
                                        + sameNetworkConfigNameList.get(2).getSubnetRange());
                                vo.setSubnetGateway(sameNetworkConfigNameList.get(0).getSubnetGateway() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetGateway() + "<br>"
                                        + sameNetworkConfigNameList.get(2).getSubnetGateway());
                                vo.setSubnetReservedFrom(sameNetworkConfigNameList.get(0).getSubnetReservedFrom() + "-"
                                        + sameNetworkConfigNameList.get(0).getSubnetReservedTo() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetReservedFrom() + "-"
                                        + sameNetworkConfigNameList.get(1).getSubnetReservedTo() + "<br>"
                                        + sameNetworkConfigNameList.get(2).getSubnetReservedFrom() + "-"
                                        + sameNetworkConfigNameList.get(2).getSubnetReservedTo());
                                vo.setSubnetStaticFrom(sameNetworkConfigNameList.get(0).getSubnetStaticFrom() + "-"
                                        + sameNetworkConfigNameList.get(0).getSubnetStaticTo() + "<br>"
                                        + sameNetworkConfigNameList.get(1).getSubnetStaticFrom() + "-"
                                        + sameNetworkConfigNameList.get(1).getSubnetStaticTo() + "<br>"
                                        + sameNetworkConfigNameList.get(2).getSubnetStaticFrom() + "-"
                                        + sameNetworkConfigNameList.get(2).getSubnetStaticTo());
                                resultList.add(vo);
                                break;
                            }
                        }
