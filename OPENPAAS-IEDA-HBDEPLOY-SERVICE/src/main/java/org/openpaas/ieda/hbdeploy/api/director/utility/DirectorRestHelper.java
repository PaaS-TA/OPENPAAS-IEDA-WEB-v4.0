    ...
    public static String trackToTask(HbDirectorConfigVO selectedDirector, SimpMessagingTemplate messageTemplate,
        ...
        try {
            ...
            while (true) {
                ...
                //1. Task 상태 정보 요청
                GetMethod getTaskStaus = new GetMethod(DirectorRestHelper.getTaskStatusURI(selectedDirector.getDirectorUrl(), selectedDirector.getDirectorPort(), taskId));
                getTaskStaus = (GetMethod) DirectorRestHelper.setAuthorization(selectedDirector.getUserId(),selectedDirector.getUserPassword(), (HttpMethodBase) getTaskStaus);
    ...
    public static String trackToTaskWithTag(HbDirectorConfigVO selectedDirector, SimpMessagingTemplate messageTemplate, 
        ...
        try {
            ...
            while (true) {
                ...
                getTaskStaus = (GetMethod) DirectorRestHelper.setAuthorization(selectedDirector.getUserId(),
                ...
                getTaskOutput = (GetMethod) DirectorRestHelper.setAuthorization(selectedDirector.getUserId(),
