...
public class HbBootStrapDeployDTO{
    ...
    public static class hybridBootStrap{
        
        private String id;
        private String publicBootStrapId;
        private String privateBootStrapId;
        private String bootstrapDeployType;
        ...
        public String getBootstrapDeployType() {
            return bootstrapDeployType;
        }
        public void setBootstrapDeployType(String bootstrapDeployType) {
            this.bootstrapDeployType = bootstrapDeployType;
        }
    }
}