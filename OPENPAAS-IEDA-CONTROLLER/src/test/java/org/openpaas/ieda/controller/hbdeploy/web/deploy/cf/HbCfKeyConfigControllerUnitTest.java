...
@WebAppConfiguration
public class HbCfKeyConfigControllerUnitTest {
    
    private MockMvc mockMvc;
    private static final ObjectMapper mapper = new ObjectMapper();
    
    @InjectMocks private HbCfKeyConfigController mockHbCfKeyConfigController;
    @Mock private HbCfKeyConfigService mockHbCfKeyService;
    
    private static final String CF_CREDS_VIEW_URL = "/deploy/hbCf/keyConfig";
    private static final String CF_CREDS_LIST_URL = "/deploy/hbCf/key/list";
    private static final String CF_CREDS_SAVE_URL = "/deploy/hbCf/key/save";
    private static final String CF_CREDS_DELETE_URL = "/deploy/hbCf/key/delete";
    ...
    *****************************************************************/
    ...
    public void setUp() throws Exception {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(mockHbCfKeyConfigController).build();
    }
    
    /****************************************************************
     * @project : Paas 이종 플랫폼 설치 자동화
     * @description : 이종 CF  인증서 정보 관리 화면 이동 Unit Test
     * @title : testgoDefaulConfig
     * @return : void
    *****************************************************************/
    @Test
    public void testgoKeyConfig() throws Exception{
        mockMvc.perform(get(CF_CREDS_VIEW_URL).contentType(MediaType.APPLICATION_JSON)).andDo(MockMvcResultHandlers.print())
        .andExpect(status().isOk())
        .andExpect(view().name("/hbdeploy/deploy/cf/hbCfKeyConfig"));
    }
    
    /****************************************************************
     * @project : Paas 이종 플랫폼 설치 자동화
     * @description : 이종 CF  인증서 정보 조회 Unit Test
    ...
    *****************************************************************/
    ...
    public void testGetCredetialConfigInfoList() throws Exception{
        ...
        when(mockHbCfKeyService.getKeyConfigInfoList()).thenReturn(expectList);
        ...
        .andExpect(jsonPath("$.records[0].keyConfigName").value(expectList.get(0).getKeyConfigName()))
        .andExpect(jsonPath("$.records[0].keyFileName").value(expectList.get(0).getKeyFileName()))
    ...
    /****************************************************************
     * @project : Paas 이종 플랫폼 설치 자동화
     * @description : 이종 CF  인증서 정보 저장 Unit Test
     * @title : testSveDefaultConfigInfo
     * @return : void
    *****************************************************************/
    @Test
    public void testSaveDefaultConfigInfo() throws Exception{
        String requestJson = mapper.writeValueAsString(setCfKeyConfigInfo());
    ...
    *****************************************************************/
     ...
     * @return : void
    *****************************************************************/
    private HbCfKeyConfigDTO setCfKeyConfigInfo() {
