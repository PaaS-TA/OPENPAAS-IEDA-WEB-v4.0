...
<div id="main">
    ...
    <div class="pdt20"> 
        ...
        <div class="fr"> 
            <sec:authorize access="hasAuthority('DEPLOY_HBDIEGO_INSTALL')">
           ...
           <sec:authorize access="hasAuthority('DEPLOY_HBDIEGO_LIST')">
            <span id="manifestBtn" class="btn btn-warning" style="width:120px">배포 파일 확인</span>
            </sec:authorize>
            
            <sec:authorize access="hasAuthority('DEPLOY_HBDIEGO_DELETE')">
