           ...
           <li>
               ...
               <ul id="deployMenu" class="collapse">
                   <sec:authorize access="hasAuthority('DEPLOY_CF_MENU')">
                       <li><a href="javascript:goPage('<c:url value="/config/credential2"/>', 'CF 설치');">CPI 정보 관리</a></li>
                   </sec:authorize>
                  <sec:authorize access="hasAuthority('DEPLOY_CF_MENU')">
                       <li><a href="javascript:goPage('<c:url value="/config/credential2"/>', 'CF 설치');">기본 정보 관리</a></li>
                   </sec:authorize>
