            ...
            <li>
               ...
               <ul id="cfMenu" class="collapse">
                   <sec:authorize access="hasAuthority('DEPLOY_HBCF_DEFAULT_MENU')">
                       <li><a href="javascript:goPage('<c:url value="/deploy/hbCf/defaultConfig"/>', '기본 정보 관리');">기본 정보 관리</a></li>
                   </sec:authorize>
                   ...
                   <sec:authorize access="hasAuthority('DEPLOY_HBCF_KEY_MENU')">
